...
- 听力、口语、阅读和写作都可以记录生词，所有条目集中在统一生词本并支持 CSV 导出。
- 写作任务需要粘贴“我的作文”和“范文”后才能完成，完成时自动形成写作档案并打开对比学习页。
- 写作档案可以回到任意历史循环补录或修改文章，不会改变当前循环进度。
- 学习记录、生词和作文全文都保存在 Supabase 共享状态中，不再依赖文件上传。
